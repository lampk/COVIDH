...
key_bvdt <- c("Bệnh viện 175", "Bệnh viện 30/4", "Bệnh viện An Bình", "Bệnh viện Bình Dân", "Bệnh viện Điều trị Covid 19 Sài Gòn", 
              ...
              "Bệnh viện Bệnh Nhiệt đới", "Bệnh viện Quận 6", "Bệnh viện Quận 7", "Bệnh viện Xuyên Á", "Bệnh viện Răng hàm mặt Trung Ương")
...
tmp <- read_excel(path = file_ttyt, sheet = " TTYT 07-01 ", skip = 2)[1:22, c(2, 16)] %>% set_names(nm = c("quan", "doh"))
