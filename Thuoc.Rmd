...
key_bvdc <- c("BV Dã chiến thu dung ĐT COVID-19 số 1", "BV Dã chiến thu dung ĐT COVID-19 số 2", 
              ...
              "Bệnh viện Dã chiến Điều trị COVID-19 Quận 8", "Bệnh viện Dã chiến Điều trị Covid-19 Thủ Đức số 2 (KTX Cao đẳng công thương)", 
...
bvdc_bc <- merge(
  ...
  bvdc2 %>%
  select(ngay, ngaygio2, place, out_inc, out_cum) %>%
  filter(ngay == today),
  by = "place", all.x = TRUE)
